# 1 "..\\user\\_Device\\bmi088.c"
# 1 "..\\user\\_Device\\bmi088.h"
# 1 "..\\user\\_Bsp\\spi.h"
...
uint32_t BMI088_read_write_byte(uint32_t tx_data)
{
    uint32_t rx_data;

    DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x040)),DISABLE);
    DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088)),DISABLE);

    DMA_SetCurrDataCounter(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x040)),1);
    DMA_SetCurrDataCounter(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088)),1);

    ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x040))->CR|=(1<<10);    
    ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088))->CR|=(1<<10);

    ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x040))->M0AR=rx_data;
    ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088))->M0AR=tx_data;

    ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000))->DR;

    while(SPI_I2S_GetFlagStatus(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)),((uint16_t)0x0002))==RESET);

    DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x040)),ENABLE);
    DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088)),ENABLE);

    while(DMA_GetFlagStatus(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x040)),((uint32_t)0x10200000))==RESET);    
    while(DMA_GetFlagStatus(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088)),((uint32_t)0x20000800))==RESET);

    DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x040)),DISABLE);    
    DMA_Cmd(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x088)),DISABLE);

    DMA_ClearFlag(((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x040)),((uint32_t)0x10200000));
