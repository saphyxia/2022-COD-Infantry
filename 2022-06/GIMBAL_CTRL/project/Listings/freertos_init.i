# 1 "..\\FreeRTOS\\FreeRTOS_Init.c"
# 1 "..\\FreeRTOS\\FreeRTOS_Init.h"
...
# 635 "..\\stm32LIB\\inc\\stm32f4xx_can.h"
...
_Bool Judge_IF_NAN(float x );



# 5 "..\\FreeRTOS\\FreeRTOS_Init.h"
...
void Delay_init(u8 SYSCLK)
{
	u32 reload;
 	...
 	SysTick_CLKSourceConfig(((uint32_t)0x00000004)); 
	fac_us=SYSCLK;							
	reload=SYSCLK;							
	reload*=1000000/( ( TickType_t ) 1000 );		
											
	fac_ms=1000/( ( TickType_t ) 1000 );			
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL|=(1UL << 1U);
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD=reload; 					
...
{ 
	...
	u32 reload=((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD;  
	ticks=nus*fac_us; 
