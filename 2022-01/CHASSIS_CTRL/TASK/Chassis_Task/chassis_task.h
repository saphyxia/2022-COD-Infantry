...
#define M_LW (33.2f)  //32.0f
#define M_R (7.5f)		//?ó??°???
#define M_L (36.5f)  //35.0f

#define ROMOTE_MAGNIFY  60 //遥控器放大系数
#define CHASSIS_SPEED_MIN 3000

extern int16_t Middle_angle;
extern RAMP_C CHASSIS_RAMP[3];

extern void chassis_task(void *pvParameters);
extern void McNhamWheel_Solve(int32_t *p);
extern void Remote_Chassis(void);
#endif
