...
/*  2颗电机(M3508x2) 
    两种模式(关闭，开启)
    没有串级PID，
*/Shoot_Motor Shoot[SHOOT_MOTOR_NUM]={ [L].Data.ID=0x202, [L].state=STURN_OFF, [L].ctrl_Calc=Shoot_Ctrl_L ,
                                       [R].Data.ID=0x201, [R].state=STURN_OFF, [R].ctrl_Calc=Shoot_Ctrl_R };
