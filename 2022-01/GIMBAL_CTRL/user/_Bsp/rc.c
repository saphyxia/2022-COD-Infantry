 ...
 * @param 
 */
float Sliding_Filter(float t,float *slideFilter)
{
    float res = 0.f;
...
float sliding_mouse_x[SF_LENGTH]={0.f,},sliding_mouse_y[SF_LENGTH]={0.f};
