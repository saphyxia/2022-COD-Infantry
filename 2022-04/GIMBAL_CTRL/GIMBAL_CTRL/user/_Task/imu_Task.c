...
//    }
    ...
    while(1)
    {
        ...
        imu.yaw_Angle = INS_angle[0]*360.0f/3.1415926f>0?INS_angle[0]*360.0f/3.1415926f-180.0f : INS_angle[0]*360.0f/3.1415926f+180.0f;
        imu.pit_Angle = INS_angle[1]*180.0f/3.1415926f;
        imu.rol_Angle = INS_angle[2]*180.0f/3.1415926f;
        imu.yaw_Gyro  = INS_gyro [2]*180.0f;
        imu.pit_Gyro  =-INS_gyro [1]*180.0f;
        imu.rol_Gyro  = INS_gyro [0]*180.0f;
        imu_working=1;
