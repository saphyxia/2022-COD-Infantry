...
//			chassis.ctrl=2;
//		}
		chassis.UI = (uint8_t)(IS_SENTRY_MODE  == true) << 3 | (uint8_t)(IF_COVER_OPEN == true) << 2 
				   | (uint8_t)(IF_SHOOT_ENABLE == true) << 1 | (uint8_t)(vision_Flag == 1);
...
//发送装载
    chassis.txMsg->Data[0] = (uint8_t)(chassis.UI);
