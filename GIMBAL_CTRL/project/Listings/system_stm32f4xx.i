# 1 "..\\stm32LIB\\CMSIS\\system_stm32f4xx.c"
...
# 124 "..\\stm32LIB\\CMSIS\\system_stm32f4xx.c"
...
static void SetSysClock(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->PLLCFGR = 25 | (336 << 6) | (((2 >> 1) -1) << 16) |
...
# 546 "..\\stm32LIB\\CMSIS\\system_stm32f4xx.c"
