...
BaseType_t xReturn = ( ( ( BaseType_t ) 0 ) );
	...
	if( xTimerQueue != 0 )
	{
# 260 "..\\FreeRTOS\\timers.c"
		{
			xReturn = xTaskCreate(	prvTimerTask,
									"Tmr Svc",
									( ( ( unsigned short ) 130 ) * 2 ),
									0,
...
# 1045 "..\\FreeRTOS\\timers.c"
 

# 1074 "..\\FreeRTOS\\timers.c"
