...
bool Key_W(void)
{
	...
	KEY_State_Judge(&Key_Info.W ,chassis.key.set.W, SHORT_CHANGE_TIM , LONG_CHANGE_TIM_W);
...
{
    static bool res = false;
	KEY_State_Judge(&Key_Info.A ,chassis.key.set.A, SHORT_CHANGE_TIM , LONG_CHANGE_TIM_A);
...
bool Key_S(void)
{
	...
	KEY_State_Judge(&Key_Info.S ,chassis.key.set.S, SHORT_CHANGE_TIM , LONG_CHANGE_TIM_S);
...
bool Key_D(void)
{
	...
	KEY_State_Judge(&Key_Info.D ,chassis.key.set.D, SHORT_CHANGE_TIM , LONG_CHANGE_TIM_D);
...
bool Key_CTRL(void)
{
    ...
    KEY_State_Judge(&Key_Info.CTRL ,chassis.key.set.CTRL, SHORT_CHANGE_TIM , LONG_CHANGE_TIM_CTRL);
